 ...
 * @author mabet
 */
public class VentanaMRPSimulado extends javax.swing.JFrame {
    ...
    public VentanaMRPSimulado(String[] mostrarA, String[] mostrarB, String[] mostrarC, String[] mostrarD) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new VentanaMRPSimulado(null, null, null, null).setVisible(true);
            }
        });
    }
